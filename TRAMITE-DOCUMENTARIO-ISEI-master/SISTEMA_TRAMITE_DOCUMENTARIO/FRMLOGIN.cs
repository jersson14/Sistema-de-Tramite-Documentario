...
namespace SISTEMA_TRAMITE_DOCUMENTARIO
{
    public partial class LOGIN : Form
    {
        ...
        int Contador;
        //Connection String
        string cs = "Data Source=PC-DOCENTES-SIS;Initial Catalog=bd_tramite_documentario;Integrated Security=True";
        ...
        {
            if (comboBoxTipo.Text == "Secretaria")
            {

                FRMMENU menu = new FRMMENU();
                menu.Show();
                this.Hide();
                menu.toolStripStatusLabel2.Text = "Usuario: " + texusuario.Text + "  *********** " + " Cargo: " + comboBoxTipo.Text.ToString();
                menu.BTNUSUARIOS.Enabled = false;


            }
            else if (comboBoxTipo.Text == "Director")
            {
                ...
                this.Hide();
                menu.toolStripStatusLabel2.Text = "Usuario: " + texusuario.Text + "  *********** " + " Cargo: " + comboBoxTipo.Text.ToString();
                menu.BTNNUEVOEXTERNO.Enabled = false;
                menu.BTNNUEVOINTERNO.Enabled = false;
