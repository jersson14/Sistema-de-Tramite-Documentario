...
namespace SISTEMA_TRAMITE_DOCUMENTARIO
{
    public partial class FRMAREAS : Form
    {
        ...
        {
            areasDataGridView.Columns[0].Width = 120;
            areasDataGridView.Columns[1].Width = 120;
            areasDataGridView.Columns[2].Width = 320;
            areasDataGridView.Columns[3].Width = 220;
       ...
       == DialogResult.Yes)
        ...
        private void nombre_areaComboBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validacion.sololetras(e);
        }

        private void encargardo_areaTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validacion.sololetras(e);
        }
