...
namespace SISTEMA_TRAMITE_DOCUMENTARIO
{
    public partial class FRMSEGUIMIENTODOCUMENTOEXTERNO : Form
    {
        ...
        public void botones_activos()
        {
            ...
            observacionTextBox1.Enabled = true;
        ...
        public void botones_desactivados()
        {
            ...
            observacionTextBox1.Enabled = false;
        ...
        {
            detalle_documento_externoDataGridView.Columns[0].Width = 180;
            detalle_documento_externoDataGridView.Columns[1].Width = 180;
            detalle_documento_externoDataGridView.Columns[2].Width = 180;
            detalle_documento_externoDataGridView.Columns[3].Width = 280;
            detalle_documento_externoDataGridView.Columns[4].Width = 150;
            detalle_documento_externoDataGridView.Columns[5].Width = 280;
            detalle_documento_externoDataGridView.Columns[6].Width = 130;
            detalle_documento_externoDataGridView.Columns[7].Width = 350;
        }
       ...
       == DialogResult.Yes)
        ...
        {
            numero_correlativoTextBox.Text = FRMBUSCARDOCEXTERNO.NumeroDoc;
            asuntoTextBox.Text = FRMBUSCARDOCEXTERNO.NombreAsunto;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (this.cbbuscar.Text == "ASUNTO")
            {
                ...
                this.detalle_documento_externoTableAdapter.asunto(this.dataSetTramite.detalle_documento_externo, txtbuscar.Text);
            }
            else if (this.cbbuscar.Text == "FECHA")
            {
                // TODO: esta línea de código carga datos en la tabla 'dataSetTramite.documento_interno' Puede moverla o quitarla según sea necesario.
                this.detalle_documento_externoTableAdapter.fecha(this.dataSetTramite.detalle_documento_externo, txtbuscar.Text);
            }
            else if (this.cbbuscar.Text == "AREA")
            {
                // TODO: esta línea de código carga datos en la tabla 'dataSetTramite.documento_interno' Puede moverla o quitarla según sea necesario.
                this.detalle_documento_externoTableAdapter.area(this.dataSetTramite.detalle_documento_externo, txtbuscar.Text);
            }
        }
        ...
        private void asuntoTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }
